<template>
    <div class="crowd-info">
        <div class="header">
            ...
            <div class="go-back" v-if="showUpdateBtn">
                <el-button type="primary" @click="calcCrowd" size="small">更新</el-button>
            </div>
            <div class="go-back" v-if="showUpdateRecordEdit">
        ...
        <div class="body" v-show="panel == 'info'" v-loading="loading">
            <div class="info-item">
                ...
                <div class="info-item-body" v-if="crowd">
                    ...
                    <div class="info-item-property">
                        ...
                        <div class="info-item-property-value">{{ crowd.crowdRealNum === null ? '加工后展示' : crowd.crowdRealNum }}</div>
                    </div>
                    <div class="info-item-property">
                    ...
                    <div class="info-item-property">
                        ...
                        <div class="info-item-property-value">{{ crowd.crowdDataDt ? formatDate(crowd.crowdDataDt, 'YYYY-MM-DD') : '加工后展示' }}</div>
                    </div>
                    <div class="info-item-property">
                    ...
                    <div class="info-item-property">
                        ...
                        <div class="info-item-property-value desc">
                            <el-tooltip :content="crowd.crowdDesc ? crowd.crowdDesc : '-'" placement="top-start">
                                <span>{{ crowd.crowdDesc ? crowd.crowdDesc : '-' }}</span>
                            </el-tooltip>
                        </div>
                    </div>
                    <template v-if="crowd.crowdType == 1">
                        <div class="info-item-property" style="width: calc(100% - 20px); padding-bottom: 10px;">
                            <div class="info-item-property-label" style="width: 100%">筛选条件</div>
                            <div class="info-item-property-value" style="width: calc(100% - 40px); float: left; padding-bottom: 20px;">
                                    ...
                                    <div class="info-filter-item">
                                        <div class="info-tag-item" v-for="(tag, tIndex) in filter.tag" :key="tIndex">
                                            ...
                                            <div class="info-tag-content" v-for="(tagComponent, tcIndex) in tag.tagComponent" :key="tcIndex">
                                                ...
                                                <el-tooltip :content="getTagValue(tag, tcIndex)" placement="top-start">
                    ...
                    <template v-if="crowd.crowdType == 5">
                        <div class="info-item-property" style="width: 100%; padding-bottom: 20px;">
                            <div class="info-item-property-label" style="width: 100%">筛选条件</div>
                            <div else class="info-item-property-value" style="width: calc(100% - 40px); float: left;">
                                <div v-if="definedDesc.valueType == 1">
                                    <div class="info-filter-item">
                                        <div class="info-tag-item">
                                            <div class="info-tag-content">
                                                <div class="info-tag-tip"></div>
                                                <div class="info-tag-title" style="margin-bottom: 0; font-weight: bold;">群体：{{getCrowdNameTwo(definedDesc.crowd)}}</div>
                                    ...
                                    <div class="info-filter-item">
                                        <div class="info-tag-item">
                                            <div class="info-tag-content">
                                                ...
                                                <div class="info-tag-time">{{getTagTime(filter)}}</div>
                                                <div class="info-tag-value1">{{getTagValueTwo(filter)}}</div>
                                            </div>
                                            <!-- <div v-if="filter.logic.length > tIndex" class="logic info-tag-logic">{{mapLogic(tIndex, filter.logic)}}</div> -->
                                        </div>
            ...
            <div class="info-item-select">
                <div v-if="showUpdateRecord" class="info-type-select" :class="{ active: infoShowType == 'record' }" @click="selectShowType('record')">
                    更新记录
                </div>
                ...
                <div class="info-item-body">
                    <div>
                        ...
                        >
                            ...
                            <el-table-column prop="crowdRealNum" label="群体数量" min-width="100"> </el-table-column>
                            ...
                            <el-table-column label="使用标签" min-width="80" fixed="right" align="left" v-if="crowd.crowdType == 1||crowd.crowdType == 5">
                                <template slot-scope="scope">
                                    <div style="text-align: center;">
                                        <el-button size="small" @click="showCrowdRow(scope.row)">详情</el-button>
                                    </div>
                                </template>
                            </el-table-column>
                    ...
                    <div>
                        <div style="position:relative;"
                            ...
                            <div class="crowd-quote-search">
                                ...
                                <div class="crowd-quote-search-item" style="width: 240px;">
                                    <el-select
                            ...
                            >
                                ...
                                <el-table-column property="sysName" label="任务应用系统"></el-table-column>
                                <el-table-column property="creator" label="任务创建人" width="150"></el-table-column>
                                <el-table-column label="任务更新机制">
                                    <template slot-scope="scope">
                    ...
                    <div v-if="tempDefinedDesc.valueType == 1">
                        <div class="info-filter-item">
                            <div class="info-tag-item">
                                <div class="info-tag-content">
                                    <div class="info-tag-tip"></div>
                                    <div class="info-tag-title" style="margin-bottom: 0; font-weight: bold;">群体：{{getCrowdNameTwo(tempDefinedDesc.crowd)}}</div>
                                    <!-- <div class="info-tag-time">{{getTagTime(tag)}}</div> -->
                                    <!-- <div class="info-tag-value1">{{getTagValueTwo(filter)}}</div> -->
                                    <div style="overflow: hidden;clear: both;"></div>
                                </div>
...
export default class CrowdInfo extends Vue {
    ...
    get showUpdateBtn() {
        ...
        // if (this.crowd.crowdType == 4 && this.crowd.crowdTouchState == 0) {
        //     return true;
        // }
    ...
    get showUpdateRecordEdit() {
        ...
        // 添加文件建群 210723
        if (this.crowd.crowdType == 1 || this.crowd.crowdType == 2 || this.crowd.crowdType == 4 || this.crowd.crowdType == 6) {
    ...
    get showUpdateRecord() {
        ...
        // 添加文件建群 210726，佳龙提需求
        if (this.crowd.crowdType == 1 || this.crowd.crowdType == 2 || this.crowd.crowdType == 4 || this.crowd.crowdType == 5 || this.crowd.crowdType == 6) {
            return true;
        }
        return false;
    }
    ...
    private goBack() {
        const target = {
            name: 'crowd-manage',
            params: {
                pageNo: this.$route.params.pageNo?this.$route.params.pageNo:'',
                crowdState: this.$route.params.crowdState?this.$route.params.crowdState:'',
                crowdType:  this.$route.params.crowdType?this.$route.params.crowdType:'',
                keyword:  this.$route.params.keyword?this.$route.params.keyword:'',
                crowdShowType: this.$route.params.crowdShowType?this.$route.params.crowdShowType:''
            }
        };
    ...
    private edit() {
        this.$router.push({
            name: 'crowd-manage',
            query:{
                code: this.crowd.crowdCode,
                type: this.crowd.crowdType
            }
        });
    }
    ...
    private getCrowdInfo() {
        ...
        this.detail(this.crowdCode).then((res: any) => {
            ...
            this.$nextTick(() => {
                // 通过这个接口，只有能够显示更新记录才能显示，否则显示应用任务
                this.getCrowdHistory();
                // console.log(this.infoShowType);
                // if(!this.infoShowType){
    ...
    private getCrowdHistory() {
        // if (!this.crowd || !this.crowd.crowdCode || !this.crowd.crowdVersion || !this.crowd.crowdType) { // 用不到后两个参数，所以删掉
        if (!this.crowd || !this.crowd.crowdCode) {
            return;
        }
    ...
    private getTagTime(tag: any) {
        let time: string = "";
        for (const k in this.crowd.crowdReferTagPOS) {
            const item = this.crowd.crowdReferTagPOS[k];
            if (tag.tagCode != undefined) {
                if (item.tagComponentCol === tag.tagCode) {
                    time = item.tagDataDt;
                }
            } else if (tag.tagData) {
                if (tag.tagData.tagCode === item.tagCode) {
                    time = item.tagDataDt;
                }
            }
        }
        if (time.length > 0 && time.length == 10) {time += '000';}
        return time.length>0?this.formatDate(parseInt(time), '数据更新日期：YYYY-MM-DD'):"";
    }
